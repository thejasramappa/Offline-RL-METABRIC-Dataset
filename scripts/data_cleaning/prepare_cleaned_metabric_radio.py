...
# Encode Radio Therapy YES/NO → 1/0
...
df.to_csv("../../data/cleaned_metabric_radio.csv", index=False)
print("✅ Cleaned dataset (Radio Therapy only) saved as 'data/cleaned_metabric_radio.csv'")
